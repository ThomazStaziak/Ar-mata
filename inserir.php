...
<html>
	...
	<header id="header">
		...
		<nav id="nav" style="position: absolute; right:12em;">
			<ul>
				...
				<li><a href="generic_adm.html">Quem Somos</a></li>
	...
	<center><h2 class="blue">Cadastre os produtos para o corpo</h2></center>
	<div class="container1-masc">
		<h3 class="white">Cadastre os produtos para o corpo</h3>
		<form action="home.php" name="form1" method="POST" enctype="multipart/form-data"/>
			...
			<label for='selecao-arquivo'><span style='color:#4d9dae;'>Selecione sua imagem para upload</span></label>
			...
			<button type="submit" class="button2" name="publicar" onclick="verificar_foto()"><span style='color:#4d9dae;'>Publicar</span></button>
			<button type="reset" class="button2" name="cancelar"><span style='color:#4d9dae;'>Cancelar</span></button>
		</form>
	</div>
	<?php
	...
	<div class='container2'>
		<h3 class="white">Exclua os produtos para o corpo</h3>
		<?php
			session_start();
			...
			echo"
				<form method='post' action='delete.php?publicar=".$linha['id']."'>
				<button for='delete' value='".$_SESSION['id_prod']=$linha['id']."' type='submit' class='button2' name='publicar1'><span style='color:#4d9dae;'>Apagar</span></button>
