...
<?php
    echo"<div id='extra'>";
          ...
          $consulta="select * from produtos_masc order by id desc";
          $resultado=mysqli_query($link,$consulta);
          if($resultado){
            while($linha = mysqli_fetch_assoc($resultado)){
						 echo"<section class='4u'> <a href='#' class='image-prod featured-prod'><center><img src='images/".$linha['Nome_imagem']."' width='170' height='200' alt=''></center></a>";
              ...
              echo"<span class='titulo'><h2> ". $_SESSION['nomeprod']=$linha["titulo"]." </h2></span>";
                ...
                echo "<form class='' enctype='multipart/form-data' action='inserir.php' method='post'>";
                ...
                echo "<select class='quantidade'  name='quantidade'>
                  ...
                  <option value='5'>5</option>
								...
								echo"<input type='submit' name='button' value='Comprar' style='background-color:#4d9dae;  ' class='button-prod'></input> </div>";
                echo "</form>";
								echo"</section>";
               }
            echo"</div>";
