...
<html>
	...
	<center><h2 class="purple">Cadastre os kits promocionais</h2></center>
	<div class="container1">
		<h3 class="white">Cadastre os kits promocionais</h3>
		<form action="prod_ins.php" name="form1" method="POST" enctype="multipart/form-data"/>
	...
	<div class='container2-masc'>
		<h3 class="white">Exclua os kits promocionais</h3>
	<?php
		session_start();

		$consulta="select * from produtos_kits";
		$resultado=mysqli_query($link,$consulta);
		if($resultado){
			while($linha = mysqli_fetch_assoc($resultado)){
		echo"
			<form method='post' action='delete_kit.php?publicar=".$linha['id']."'>
