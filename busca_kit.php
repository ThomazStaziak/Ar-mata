  ...
  <body>
    ...
    <header id="header">
      ...
      <div id="pesquisa">
        ...
        <form class="" action="busca_fem.php" method="post">
    ...
    echo"<div id='extra'>";
          ...
          echo"<header class='major'>";
					echo "<h2 class='purple'>Produtos kits promocionais</h2>";
				  echo "<p>Confira os melhores produtos kits promocionais da Arômata.</p>";
					echo "</header>";
    echo"<div class='row no-collapse-1'>";
    $consulta="SELECT * FROM produtos_kits where titulo LIKE '%$busca%'";
