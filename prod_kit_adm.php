    ...
    <header id="header">
      ...
      <nav id="nav">
  			<ul class="wrapper-menu">
  				...
  				<li><a href="prod_home.html" class="button special">Produtos</a></li>
          <li><a href="adm.html" >Administração</a></li>
  			</ul>
  		</nav>
      <div id="pesquisa">
  			<!-- <img src="images/search.png" id="fotoimg" alt="Faça sua busca"/> -->
        <form class="" action="busca_kit.php" method="post">
...
<?php
    echo"<div id='extra'>";
          ...
          echo"<header class='major'>";
					echo "<h2 style='color:orange'>Kits promocionais</h2>";
				  echo "<p>Confira os melhores kits promocionais da Arômata.</p>";
					echo "</header>";
          echo"<div class='row no-collapse-1'>";
          $consulta="select * from produtos_kits order by id desc";
              ...
              echo"<span class='titulo'><h2> ". $_SESSION['nomeprod']=$linha["titulo"]." </h2></span>";
                ...
                echo "<select class='quantidade'  name='quantidade'>
                  ...
                  <option value='5'>5</option>
								...
								echo"<input type='submit' name='button' value='Comprar' style='background-color:orange; ' class='button-prod'></input> </div>";
                echo "</form>";
								echo"</section>";
               }
            echo"</div>";
